            ...
            <div className="projects">
                ...
                <span className="Pro">
                    <div className="project2"><a href=""> <img className="img" src={img2} /> </a>
                        <h4>What have we been upto?</h4>CollegeSpace has been the one-stop solution for students the night before exam. We're now building ExamSpace, LearnSpace and the classNameSpace App
                    </div>
                </span>
                <span className="Pro">
